...
Blockly.BlockSvg.prototype.refreshColour = function() {
  if (Blockly.Connection.prototype.returnNewColour() != 'noChange') {
    this.blockClass = Blockly.Connection.prototype.returnNewColour();
    if (Blockly.Connection.prototype.getConnectBool() == false) {
      this.blockClass = this.originClass;
      console.log("Colour has been reset due to disconnect!");
    }
    this.colour_ = this.blockClass[4];
    this.updateColour();
    this.check_ = this.blockClass
    for (var i = 0; i < this.inputList.length; i++) {
      this.inputList[i].connection.check_ = this.blockClass;
    }
    //console.log(this.inputList[0].connection.check_); //This is the path for connection parameters.
    //this.colour_ = Blockly.Connection.prototype.resetColour();
    Blockly.Connection.prototype.resetColour();
  }
}

// Blockly.Block.prototype.reType = function(render) {
//   if (!this.workspace) {
//     return
//   }
//   var topBlockH = this.getTopLevel();
//   topBlockH.reforgeUp();
//   topBlockH.reforgeDown();
//   if (render) {
//     this.renderBlank();
//   }
// topBlockH.updateColourStack();
// }

//Recursively changes the colour of all connected blocks
// Blockly.BlockSvg.prototype.updateColourStack = function() {
//     this.updateColour();
//     for (var i = 0, child; child = this.childBlocks_[i]; i++) {
//         if (child && child.outputConnection) {
//             child.updateColourStack();
//         }
//     }
// };
