...
// ];
// var DataType = [
//   ['Int', '#c0c0c0'], //Int = Light Grey
//   ['Integer', '#515151'], //Integer = Dark Grey
//   ['Float', '#b2b2b2'], //Float = Grey
//   ['Double', '#000000'] //Double = Black
// ];
...
var DataType = [
  ['Int', [], [],  ['Int'],'#c0c0c0'], //Int = Light Grey
  ['Integer', [], [], ['Integer'], '#515151'], //Integer = Dark Grey
  ['Float', [], [], ['Float'], '#b2b2b2'], //Float = Grey
  ['Double', [], [], ['Double'], '#000000'] //Double = Black
];
...
Blockly.Connection.prototype.checkType_ = function(otherConnection) {
  ...
  if (otherConnection.check_[0] == this.check_[0]) {
    newColour = otherConnection.check_
    return true;
  }
    ...
    console.log('Child TypeClass:\n', this.check_, '\nis child of', otherConnection.check_);
    return true;
  }
  else if (otherConnection.check_[3].indexOf(this.check_[0]) != -1) {
    newColour = this.check_

    return true;
  }
  else if (this.check_[3].indexOf(otherConnection.check_[0]) != -1) {
    newColour = otherConnection.check_
...
Blockly.Connection.prototype.CheckParent = function(Input, Static) {
  ...
  else if (Input[2].indexOf(Static[0]) != -1) {
      newColour = Static
    return true;
  }
  else {
  ...
  //return this.CheckParent(TypeClass[Input[2][1]], Static);
  for (var i = 0; i < Input[2].length; i++) {
     return this.CheckParent(TypeClass[Input[2][i]], Static);
        }
    }
};
...
Blockly.Connection.prototype.getConnectBool = function(){
  return connectBool;
};
